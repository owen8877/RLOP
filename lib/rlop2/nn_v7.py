...
from .env import Baseline, Info, Policy, PriceEstimator, State
...
class GaussianPolicy_v7(Policy):
...
class PriceEstimator_v7(PriceEstimator):
    ...
    def update(self, loss_: np.ndarray, state: State, info: Info):
...
class PriceEstimator_v7_grad_fn(Baseline):
    def __init__(self, net: CombinedResNet, optimizer: Adam):
        super().__init__()
