...
class Training(TestCase):
    def _parameters(self):
        ...
        return EnvSetup(
            ...
            _dt=(_dt := 7 / 252),
            frictions=np.random.rand(parallel_n) * 1e-1,
            is_call_option=True,
    ...
    def test_learn_price_first(self):
        ...
        policy_gradient(
            ...
            episode_n=200,
            pi_frozen=True,
            tensorboard_label=f"rlop2-{exp_name}-test-11",
        )
    ...
    def test_draw_plot(self):
        ...
        T, K, r, sigma, friction = 28 / 252, 1.0, 0.04, 0.5, 1e-1
        ...
        for i, mu in enumerate([-10, -5, 0, 5, 10]):
    ...
    def test_draw_influence_of_mu(self):
        ...
        T, K, r, sigma, friction = 28 / 252, 1.0, 0.04, 0.2, 1e-3
        ...
        for i, mu in enumerate([-0.5, 0, 0.5]):
            tensor = build_state_info_tensor(mu)
