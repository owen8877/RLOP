...
class QLBSModel:
    def __init__(self, is_call_option: bool, checkpoint: str, anchor_T: float, print_every: int = 50):
    ...
    def fit(
        ...
        def loss():
            ...
            # print(state_info_tensor, estimated_price)
        ...
        return QLBSFitResult(
            ...
            implied_vols=latent_vol.numpy() / _scaled_tte.numpy() ** 0.5,
        )
...
class TestTrainedModel(TestCase):
    def test_load_models(self):
        ...
        # load trained models
        model = QLBSModel(
            is_call_option=is_call_option, checkpoint="trained_model/test8/risk_lambda=1.0e-01/policy_1.pt", anchor_T=T
        )
    ...
    def test_invert_curve(self):
        ...
        nn_policy = GaussianPolicy_v6(
            is_call_option, from_filename=f"trained_model/test8/risk_lambda=1.0e-01/policy_1.pt"
        )
