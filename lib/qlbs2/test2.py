...
class Training(TestCase):
    ...
    def test_learn_policy_only(self):
        ...
        for risk_lambda in risk_lambdas:
            ...
            nn_baseline = NNBaseline_v3(
                lr=1e-4, from_filename=f"{self._path(risk_lambda, exp_name='test1')}/baseline_1.pt"
            )
            ...
            policy_gradient(
                ...
                nn_baseline,
                episode_n=200,
                tensorboard_label=f"qlbs2-{exp_name}-learn-policy-only",
                V_frozen=True,
            )
