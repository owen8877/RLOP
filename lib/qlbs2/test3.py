...
class Training(TestCase):
    ...
    def test_learn_both(self):
        ...
        for risk_lambda in risk_lambdas:
            ...
            nn_baseline = NNBaseline_v3(
                ...
                if check_point
                else f"{self._path(risk_lambda, exp_name='test1')}/baseline_1.pt",
            ...
            nn_policy = GaussianPolicy_v3(
                ...
                if check_point
                else f"{self._path(risk_lambda, exp_name='test2')}/policy_1.pt",
                reset_optimizer=True,
            )
            ...
            policy_gradient(
                ...
                nn_baseline,
                episode_n=500,
                tensorboard_label=f"qlbs2-{exp_name}-learn-both",
            )
    ...
    def test_draw_plot(self):
        ...
        for i, mu in enumerate([-0.2, 0.0, 0.2]):
            ...
            nn_action = nn_policy.batch_action(tensor.cuda(), random=False).cpu().numpy()
