...
def summarize_symbol_period_hedging(
    ...
    Dynamic hedging summary with:
      ...
      • World vol per day & bucket still comes from that day's ATM IV.
    ...
    # First pass: per-day calls + pooled calls_all
    ...
    # Second pass: per-day hedging using period×bucket calibration
