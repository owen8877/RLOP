...
def hedging_spy20(world: str = "gbm"):
    ...
    out_dir = f"SPY_20Q1_hedging_v_{world}56"
...
def hedging_xop20(world: str = "gbm"):
    ...
    out_dir = f"XOP_20Q1_hedging_v_{world}56"
...
def hedging_spy25(world: str = "gbm"):
    ...
    out_dir = f"SPY_25Q2_hedging_v_{world}56"
...
def hedging_xop25(world: str = "gbm"):
    ...
    out_dir = f"XOP_25Q2_hedging_v_{world}56"
