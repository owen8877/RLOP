...
def summarize_symbol_period_ivrmse(
    ...
    for day in iterator:
        ...
        for bucket, g in calls.groupby("bucket"):
            ...
            # Heston baseline
            if run_heston:
                h_params, _ = calibrate_heston_bucket(g, u_max=60.0, n_points=201)  # stable Simpson settings
...
def summarize_symbol_period_hedging(
    ...
    for day in iterator:
        ...
        for bucket_label, calls_b in calls.groupby("bucket"):
            ...
            # Heston
            if run_heston:
                h_params, _ = calibrate_heston_bucket(calls_b, u_max=60.0, n_points=201)
